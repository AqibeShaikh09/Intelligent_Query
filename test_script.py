...
BEARER_TOKEN = "YOUR_HACKRX_TOKEN"  # Replace with your actual token
...
for i, (ans, exp) in enumerate(zip(answers, expected_answers)):
    # Simple string match, can be improved with fuzzy matching
    if ans.strip().lower() == exp.strip().lower():
        correct += 1
